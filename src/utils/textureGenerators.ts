...
export function createBakedEnvironmentTexture(renderer: THREE.WebGLRenderer): THREE.Texture {
  ...
  bgGrad.addColorStop(0.35, '#0a0a0a');
  ...
  softbox.addColorStop(0.2, 'rgba(255, 255, 255, 0.6)');
  softbox.addColorStop(0.5, 'rgba(255, 255, 255, 1.0)');
  softbox.addColorStop(0.8, 'rgba(255, 255, 255, 0.6)');
  ...
  keyLight.addColorStop(0.25, 'rgba(255, 255, 255, 0.85)');
  keyLight.addColorStop(0.65, 'rgba(255, 255, 255, 0.25)');
  ...
  edgeStrip.addColorStop(0, 'rgba(255, 255, 255, 0)');
  edgeStrip.addColorStop(0.5, 'rgba(255, 255, 255, 0.9)');
  edgeStrip.addColorStop(1, 'rgba(255, 255, 255, 0)');
  ctx.fillStyle = edgeStrip;
  ctx.fillRect(width * 0.88, height * 0.35, width * 0.08, height * 0.4);

  // Soft secondary rim light (terracotta rim accent)
  ...
  rimLight.addColorStop(0, 'rgba(255, 255, 255, 0.9)');
  rimLight.addColorStop(0.45, 'rgba(224, 107, 72, 0.35)');
