...
export function SectionHeader({
  ...
  return (
    <div className={`mb-12 ${isCenter ? 'text-center' : 'text-left'} ${className}`}>
      ...
      <div
        className={`inline-flex items-center gap-1.5 text-xs font-mono uppercase tracking-widest text-[#e06b48] font-semibold mb-3 ${
      ...
      {/* Two-Tone Headline */}
      <h2
        className={`font-editorial text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight leading-tight ${
      ...
      {subline && (
        <p
          className={`text-stone-400 font-normal text-sm sm:text-base mt-3 leading-relaxed font-sans ${
